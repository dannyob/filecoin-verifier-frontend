...
class MakeRequestModalC extends Component<ModalProps, States> {
    ...
    render() {
        return (
            ...
            {this.props.verifier.use_case ==="Automatic Verifier" ? <div className="modalautomatic">
            <div className="title">Automatic notary</div>
                <div className="automatictext">This notary has automatic verification, click on the button to get verified in their website</div>
                <ButtonPrimary onClick={this.redirect}>Get verified</ButtonPrimary>
            </div> : 
                <form>
...
export default MakeRequestModalC;